'''
    SCRIPT NAME: 
        fari_proxyMeshesCreator
    
    AUTHOR: 
        Paolo Farinello - paolo.farinello@gmail.com
        
    DESCRIPTION:
        Easily decompose a single mesh into a collection of proxy meshes, associating faces to joints according to their distance or skin weights.
        Edit proxy meshes arbitrarily, selecting faces to associate to joints.
